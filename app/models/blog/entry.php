...
<form method="POST" class="form-horizontal form-bordered" id="mainform" enctype="multipart/form-data">
			...
			<div class="wrapper bg-silver border-bottom">
				<span class="btn-group m-r-5">
					<div class="input-group date" id="datetimepicker1">
						...
						<input type="text" name="posting_date" class="form-control " placeholder="投稿日時" value="2018/08/19 23:18" />
						<div class="input-group-addon">
				...
				<span class="pull-right">
					<div class="toggle btn btn-danger off" data-toggle="toggle" style="width: 75px; height: 34px;">
					...
					<div class="toggle-group">
						<label class="btn btn-success toggle-on">公開</label>
						<label class="btn btn-danger active toggle-off">下書き</label>
	...
	<input type="hidden" name="FLUXDEMOTOKEN" value="b754b087d8f06fbcdaefdf070b79cbedc5ce1fd5" />
</form>
